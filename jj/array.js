// 1st method
const myarray = [1, 2, 3, 4, 5, 6, true, "Muneeb"];
console.table(myarray);
// 2nd method
const myfruits = ["Apple", "Banana", "Mango", "Peach"];
...
const changedValue = originalArrray.slice(0,4);
...
// concate
const myname = ["Muneeb Hasan"];
const fatherName = ["Mehmood"];
console.log(myname);
